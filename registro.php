	...
	<div class="image-container set-full-height" style="background-image: url('assets/img/paper-1.jpeg')">
		                    ...
		                    <form action="auth/registrar.php" method="POST">
		                        ...
		                        <div class="tab-content">
		                            ...
		                            <div class="tab-pane" id="account">
		                                <h5 class="info-text"> Cuales son tus mejores destrezas?<strong> (Selecciona 3)</strong></h5>
		                                <div class="row">
		                                    <div class="col-sm-8 col-sm-offset-2">
		                                        <div class="col-sm-3">
		                            ...
		                            <div class="tab-pane" id="address">
		                                <div class="row">
		                                    <div class="col-sm-12">
		                                        <h5 class="info-text"> Residencia: </h5>
		                                    </div>
		                                    <div class="col-sm-5 col-sm-offset-1">
		                                        <div class="form-group">
		                                            <label>Ciudad</label>
		                                            <input type="text" class="form-control" placeholder="Sincelejo <3">
		                                        </div>
		                                    </div>
		                                    <div class="col-sm-5">
		                                        <div class="form-group">
		                        ...
		                        <div class="wizard-footer">
		                            <div class="pull-right">
		                            	Ya tienes cuenta? <a href="login.php">Iniciar sesión.</a> &nbsp &nbsp 
	    ...
	    <div class="footer">
	        <div class="container text-center">
	            PAMI | Adan. 2018 - Todos los derechos son reservados, el uso de los logos PAMI, Blinter son propiedad de Blinter Universe.</a>
	        </div>
	    </div>
	</div>
